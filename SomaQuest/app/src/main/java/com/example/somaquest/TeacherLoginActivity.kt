...
class TeacherLoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.teacher_login) // Make sure this matches your XML file name
        ...
        val RegisterTeacher=findViewById<TextView>(R.id.register_link)
        RegisterTeacher.setOnClickListener {
            // Intent to navigate to the FormalEducationActivity
