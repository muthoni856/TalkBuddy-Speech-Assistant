...
class KnittingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.knittingpage) // Make sure this matches your XML file name

        // Set onClick listeners for buttons to navigate to other activities
        val knittingButton1=findViewById<Button>(R.id.knittingButton1)
        knittingButton1.setOnClickListener {
            // Intent to navigate to the FormalEducationActivity
            val intent = Intent(this, KnittingExerciseActivity::class.java)
