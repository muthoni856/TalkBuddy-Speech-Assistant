...
class MathModule : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.math_module) // Make sure this matches your XML file name

        // Set onClick listeners for buttons to navigate to other activities
        val MathModuleButton1=findViewById<Button>(R.id.MathModuleButton1)
        MathModuleButton1.setOnClickListener {
